    ...
    return (
        <div className='h-16 bg-neutral-800 border-t border-neutral-700 text-white grid grid-cols-3 text-xs md:text-base px-2 md:px-5'>
            ...
            <div className='flex items-center justify-center'>
                {globalIsTrackPlaying ? <PauseCircleIcon onClick={handlePlayPause} className='h-10 w-10' color='#AF85FF' /> : <PlayCircleIcon onClick={handlePlayPause} className='h-10 w-10' color='#AF85FF' />}
            </div>
            <div></div>
        </div>
    );
